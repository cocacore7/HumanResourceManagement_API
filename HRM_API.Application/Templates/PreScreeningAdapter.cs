...
{
    public class PreScreeningAdapter(IMailRepository repository) : ITemplateRepository
    {
        ...
        {
            var dto = await _repository.GetPreScreeningAsync(id) ?? throw new Exception($"No se encontró la prueba con id={id}");
