...
using HRM_API.Infraestructure.Repositories.Comment;
...
builder.Services.AddScoped<ITemplateRepository, RecoveryCodeAdapter>();
builder.Services.AddScoped<ITemplateRepository, RenewPasswordAdapter>();
